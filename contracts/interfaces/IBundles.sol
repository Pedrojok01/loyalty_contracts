...
interface IBundles {
    ...
    event BundleAssetsClaimed(uint256 indexed tokenId, address indexed owner, address[] addresses, uint256[] numbers);
     ...
     * @param _addresses concat assets addresses;
     * e.g. [ERC-20_address1, ERC-20_address2, ERC-721_address_1, ERC-1155_address_1, ERC-1155_address_2]
     * @param _numbers describes how many eth, ERC-20 token addresses length, ERC-721 token addresses length,
